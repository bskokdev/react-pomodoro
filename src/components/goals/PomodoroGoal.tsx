...
export function PomodoroGoal({
  ...
  return (
      <div
          className="flex flex-col gap-y-4 md:flex-row md:items-center md:justify-between md:gap-x-4 bg-gray-100 rounded-xl px-4 py-4 my-4 font-bold text-gray-700">
